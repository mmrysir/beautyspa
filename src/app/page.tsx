      ...
      <section id="home" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-28">
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto flex flex-col items-center pb-20 md:pb-28">
          ...
          <a
            ...
            className="group w-full max-w-sm flex items-center justify-center gap-3 px-8 py-4 bg-spa-accent text-white rounded-2xl hover:bg-[#b00f0f] transition-all shadow-xl hover:shadow-spa-accent/30 hover:-translate-y-0.5 mb-4 font-semibold tracking-wider uppercase text-sm"
          >
